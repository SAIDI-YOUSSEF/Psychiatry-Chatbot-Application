...
# Initialize TTS engine with English voice
...
async def get_response(query: str = Form(...)):
    ...
    audio_file_path = "C:/Users/saidi youssef/Desktop/rag_med/static/response_audio.wav"

    # Convert the response text to speech and save to file
